...
public class DriverFunction {
    ...
    public DriverFunction(HardwareMap hardwareMap, Telemetry telemetry, double smoothness) {
        this.rf = new DrivingMotor(hardwareMap.dcMotor.get("right_drive"), smoothness, DEFAULT_RUNMODE);
        this.lf = new DrivingMotor(hardwareMap.dcMotor.get("left_drive"), smoothness, DEFAULT_RUNMODE);
